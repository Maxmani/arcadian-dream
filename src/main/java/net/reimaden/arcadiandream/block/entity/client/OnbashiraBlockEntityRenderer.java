...
public class OnbashiraBlockEntityRenderer implements BlockEntityRenderer<OnbashiraBlockEntity> {

    public OnbashiraBlockEntityRenderer(@SuppressWarnings("unused") BlockEntityRendererFactory.Context context) {
        super();
    }

    @Override
    public void render(OnbashiraBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        float altitude = MathHelper.sin((age + tickDelta) / 10.0f) * 0.1f + 1.35f;
